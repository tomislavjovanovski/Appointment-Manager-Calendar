...
Call log:
  ...
  - waiting for getByTestId('booking-dialog')
    11 × locator resolved to <div data-testid="booking-dialog" class="max-h-[calc(100dvh-1rem)] overflow-y-auto sm:max-h-[calc(100vh-2rem)]">…</div>
          ...
          - generic [ref=e45]:
            ...
            - generic [ref=e58]:
              - generic [ref=e59]:
                - img [ref=e60]
                - text: Notes
              - textbox "Notes" [ref=e63]: Routine check-up
          - generic [ref=e65]:
